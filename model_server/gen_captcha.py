...
try:
    os.remove('./images/' + str(modelNo) + '/.DS_Store')
except Exception as e:
    print(e)
imgs_list = os.listdir("./images/" + str(modelNo))
...
def gen_captcha_text_and_image():
    ...
    while (True):
        ...
        captcha_image = Image.open('./images/' + str(modelNo) + "/" + imgs_list[captcha_id]).resize((160, 60))
